    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {     	
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("欢迎来到太极空间", 'Powered by YLUI，感谢YLUI与Tim Chan提供支持<br/><br/><img style="width: 100%" src="./res/img/icon/wellcome.png"/></p>');
            }, 1000)
		  });
		  YL.onReady(function () {
			setTimeout(function () {
              YL.msg("友情提示", '应用可以通过右键在外部打开哦~');
            }, 1500)
		  });
		  YL.onReady(function () {
			setTimeout(function () {
              YL.msg("祝你天天好心情~", 'Enjoy~~');
            }, 2000)
          });
		}
